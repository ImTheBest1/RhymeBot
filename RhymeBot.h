...
private:
	...
	string toQuery;
    map<string, vector<Sound> > dictionaryMap;
    vector<set<int>*> counterVector;

    vector<set<int>*> headProTwoCounterVector;
    vector<set<int>*> headProThreeCounterVector;

    vector<set<int>*> tailProTwoCounterVector;
    vector<set<int>*> tailProThreeCounterVector;

    vector<multimap<int, string>*> partOfSpeechVector;

    vector<multimap<int, multimap<string, string>>*> headProVector;
    vector<multimap<int, multimap<string, string>>*> headProTwoVector;
    vector<multimap<int, multimap<string, string>>*> headProThreeVector;

    vector<multimap<int, multimap<string, string>>*> tailProVector;
    vector<multimap<int, multimap<string, string>>*> tailProTwoVector;
    vector<multimap<int, multimap<string, string>>*> tailProThreeVector;

    vector<multimap<int, multimap<long long, string>>*> superHasher;
    vector<set<int>*> superHasherCounterVector;
...
public:
    ...
    string findBestRhyme(PART_OF_SPEECH partOfSpeech, string rhymesWith);
    string findBestRhyme(int numberOfSyllables, PART_OF_SPEECH partOfSpeech, string rhymesWith);
    ...
    string findBestAlliteration(PART_OF_SPEECH partOfSpeech, string alliterationWith);
    string findBestAlliteration(int numberOfSyllables, PART_OF_SPEECH partOfSpeech, string alliterationWith);
    ...
    // If no such word exists, returns ""
    string findPerfectWord(int numberOfSyllables, PART_OF_SPEECH partOfSpeech, string rhymesWith, string alliterationWith);

    int dictSize();
    int partOfSpeechVectorSize();
    void setPartOfSpeechVector(string word, PART_OF_SPEECH partOfSpeech);
    multimap<int, string>& getPartOfSpeechMap(PART_OF_SPEECH partOfSpeech);
    multimap<string, string>& getHeadProMap(PART_OF_SPEECH partOfSpeech, int numberOfSyllables, string word);
    multimap<string, string>& getTailProMap(PART_OF_SPEECH partOfSpeech, int numberOfSyllables, string word);
    void printMap(PART_OF_SPEECH partOfSpeech, int numberOfSyllables);
    string theBest(int numberOfSyllables, PART_OF_SPEECH partOfSpeech, string rhymesWith, string alliterationWith);
    void checkProMap();
};
